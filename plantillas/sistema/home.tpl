            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url(images/main-slider/main-slider-1-1.jpg);"></div>
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url(images/main-slider/main-slider-1-2.jpg);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-7">
        ...
        <section class="about-one">
            <img src="images/icons/about-bg-icon-1-1.png" class="about-one__bg-shape-1" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
        ...
        <section class="testimonials-one">
            <img src="images/icons/testimonials-bg-1-1.png" class="testimonials-one__bg" alt="">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-5">
                        <div class="contact-two__image">
                            ...
                            <img src="images/resources/contact-1-1.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 mb-4">
                                        <a href="tel:92-666-888-0000" class="main-header__info-phone_contacto">
                                            ...
                                            <span class="main-header__info-phone_contacto-content">
                                                <span class="main-header__info-phone_contacto-text">Llámanos</span>
                                                <span class="main-header__info-phone_contacto-title">55 1234 5678</span>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="col-sm-12 col-md-6 mb-4">
                                        <a href="tel:92-666-888-0000" class="main-header__info-phone_contacto">
                                            ...
                                            <span class="main-header__info-phone_contacto-content">
                                                <span class="main-header__info-phone_contacto-text">Recibe recomendación técnica al instante</span>
                                                <span class="main-header__info-phone_contacto-title">55 1234 5678</span>
                                            </span>
                                        </a>
                                    </div>
